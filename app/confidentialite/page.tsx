...
export default function PrivacyPage() {
  return <main id="contenu" className="legal-page">
    ...
    <h2>Ce que le site enregistre</h2><p>Le site ne possède pas de compte client, ne dépose pas de cookie publicitaire et n’enregistre pas directement les informations du formulaire dans une base de données. Les champs restent dans votre navigateur jusqu’à ce que vous décidiez d’ouvrir WhatsApp ou votre logiciel de messagerie. Le calcul indicatif du devis est effectué directement dans votre navigateur.</p><p>Lorsque vous saisissez au moins deux caractères dans le champ « Commune ou adresse », ce texte est transmis au service cartographique officiel de la Confédération, geo.admin.ch, uniquement pour afficher des propositions d’adresses suisses. Helnet ne reçoit pas et ne stocke pas ces recherches. Le service cartographique peut traiter des données techniques nécessaires à son fonctionnement, comme l’adresse IP.</p>
